...
class Group:
    ...
    def __init__(self):
        ...
        self.scores = {}    # dict: maps group # to list of scores
        self.grp_ever = 0
    ...
    def list_scores(self, me):
        full_list = "Ranking List: ------------" + "\n"
        full_list += str(self.scores) + "\n"
        return full_list

    def update_scores(self, me, n):
        self.scores[me] += n
